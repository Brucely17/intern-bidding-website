...
const FormInput = ({ id, label, type, value, onChange }) => (
  <div className='flex flex-col mb-6 mr-4 relative'>
    <label htmlFor={id} className='text-lg font-semibold mb-2 text-white '>{label}</label>
    <input
      type={type}
      id={id}
      placeholder={label}
        ...
        <form onSubmit={handleSubmit} className='flex flex-col gap-8 mt-16'>
          {step === 1 && (
            <div className='flex flex-col p-5 rounded-lg'>
              <h2 className='text-3xl font-mono mb-8 text-white'>Vendor Details</h2>
          ...
          {step === 2 && (
            <>
            <h2 className='text-3xl font-bold mb-4  text-white  '>Bank Details</h2>
          ...
          {step === 3 && (
            <div className='flex flex-col'>
              <h2 className='text-3xl font-bold mb-8 text-white'>Additional Details</h2>
              <FormSelect
                id="vendorType"
                label="Vendor Type"
              ...
              <center>
                ...
                >
                  Submit
                  <svg className="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7"></path></svg>
                </button>
              </center>
            </div>
          )}
